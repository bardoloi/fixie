namespace Fixie.VSTestAdapter.Listeners
{
    ...
    [Serializable]
    public class VsConsoleListener : Listener
    {
        private readonly IFrameworkHandle frameworkHandle;

        public VsConsoleListener(IFrameworkHandle frameworkHandle)
        {
        ...
        {
            var assemblyName = typeof(VsConsoleListener).Assembly.GetName();
